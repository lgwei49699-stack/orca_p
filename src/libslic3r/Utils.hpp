...
#define CLI_MODEL_REPAIR_ERROR -25
#define CLI_RESULT_WRITE_ERROR -26
...
{
    return boost::starts_with(url, SLIC3R_URL_SCHEME "://open") || boost::starts_with(url, "orcaslicer://open");
}
