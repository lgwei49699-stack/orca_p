...
static std::atomic<bool> s_network_module_loaded{false};

bool NetworkAgent::use_legacy_network = true;

typedef int (*func_start_print_legacy)(
    void* agent, PrintParams_Legacy params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn);
typedef int (*func_start_local_print_with_record_legacy)(
    void* agent, PrintParams_Legacy params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn);
typedef int (*func_start_send_gcode_to_sdcard_legacy)(
    void* agent, PrintParams_Legacy params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn);
...
NetworkAgent::NetworkAgent(std::string log_dir)
{
    ...
    m_alive.store(network_agent != nullptr);
    BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                            << boost::format(", this %1%, network_agent=%2%, create_agent_ptr=%3%, log_dir=%4%") % this % network_agent %
                                   create_agent_ptr % log_dir;
}
...
NetworkAgent::~NetworkAgent()
{
    m_alive.store(false);
    int   ret       = 0;
    void* old_agent = network_agent;
    if (network_agent && destroy_agent_ptr) {
        ret = destroy_agent_ptr(network_agent);
    }
    network_agent = nullptr;
    BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                            << boost::format(", this %1%, network_agent=%2%, destroy_agent_ptr=%3%, ret %4%") % this % old_agent %
                                   destroy_agent_ptr % ret;
}
...
std::string NetworkAgent::get_libpath_in_current_directory(std::string library_name)
{
    ...
    if (!ret) {
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format(", GetModuleFileNameW return error, can not Load Library for %1%") % library_name;
        return lib_path;
    }
    ...
    lib_path = (boost::filesystem::path(file_name_string).parent_path() / (library_name + ".dll")).string();
#else
#endif
    return lib_path;
}
...
int NetworkAgent::initialize_network_module(bool using_backup)
{
    ...
    /*if (!netwoking_module) {
        ...
        memset(lib_wstr, 0, sizeof(lib_wstr));
        ::MultiByteToWideChar(CP_UTF8, NULL, library.c_str(), strlen(library.c_str()) + 1, lib_wstr, sizeof(lib_wstr) /
    sizeof(lib_wstr[0])); netwoking_module = LoadLibrary(lib_wstr);
    }*/
    if (!netwoking_module) {
        ...
        if (library_path.empty()) {
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                    << boost::format(", can not get path in current directory for %1%") % BAMBU_NETWORK_LIBRARY;
            return -1;
        }
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << boost::format(", current path %1%") % library_path;
        memset(lib_wstr, 0, sizeof(lib_wstr));
        ::MultiByteToWideChar(CP_UTF8, NULL, library_path.c_str(), strlen(library_path.c_str()) + 1, lib_wstr,
                              sizeof(lib_wstr) / sizeof(lib_wstr[0]));
        netwoking_module = LoadLibrary(lib_wstr);
    }
#else
    ...
    // load the functions
    check_debug_consistent_ptr = reinterpret_cast<func_check_debug_consistent>(
        get_network_function("bambu_network_check_debug_consistent"));
    ...
    set_on_printer_connected_fn_ptr = reinterpret_cast<func_set_on_printer_connected_fn>(
        get_network_function("bambu_network_set_on_printer_connected_fn"));
    set_on_server_connected_fn_ptr = reinterpret_cast<func_set_on_server_connected_fn>(
        get_network_function("bambu_network_set_on_server_connected_fn"));
    ...
    set_get_country_code_fn_ptr = reinterpret_cast<func_set_get_country_code_fn>(
        get_network_function("bambu_network_set_get_country_code_fn"));
    set_on_subscribe_failure_fn_ptr = reinterpret_cast<func_set_on_subscribe_failure_fn>(
        get_network_function("bambu_network_set_on_subscribe_failure_fn"));
    set_on_message_fn_ptr      = reinterpret_cast<func_set_on_message_fn>(get_network_function("bambu_network_set_on_message_fn"));
    set_on_user_message_fn_ptr = reinterpret_cast<func_set_on_user_message_fn>(
        get_network_function("bambu_network_set_on_user_message_fn"));
    set_on_local_connect_fn_ptr = reinterpret_cast<func_set_on_local_connect_fn>(
        get_network_function("bambu_network_set_on_local_connect_fn"));
    set_on_local_message_fn_ptr = reinterpret_cast<func_set_on_local_message_fn>(
        get_network_function("bambu_network_set_on_local_message_fn"));
    ...
    start_device_subscribe_ptr = reinterpret_cast<func_start_device_subscribe>(
        get_network_function("bambu_network_start_device_subscribe"));
    ...
    send_message_to_printer_ptr = reinterpret_cast<func_send_message_to_printer>(
        get_network_function("bambu_network_send_message_to_printer"));
    ...
    get_user_selected_machine_ptr = reinterpret_cast<func_get_user_selected_machine>(
        get_network_function("bambu_network_get_user_selected_machine"));
    set_user_selected_machine_ptr = reinterpret_cast<func_set_user_selected_machine>(
        get_network_function("bambu_network_set_user_selected_machine"));
    ...
    start_send_gcode_to_sdcard_ptr = reinterpret_cast<func_start_send_gcode_to_sdcard>(
        get_network_function("bambu_network_start_send_gcode_to_sdcard"));
    ...
    check_user_task_report_ptr = reinterpret_cast<func_check_user_task_report>(
        get_network_function("bambu_network_check_user_task_report"));
    ...
    get_model_mall_home_url_ptr = reinterpret_cast<func_get_model_mall_home_url>(
        get_network_function("bambu_network_get_model_mall_home_url"));
    get_model_mall_detail_url_ptr = reinterpret_cast<func_get_model_mall_detail_url>(
        get_network_function("bambu_network_get_model_mall_detail_url"));
    ...
    put_model_mall_rating_url_ptr = reinterpret_cast<func_put_model_mall_rating_url>(
        get_network_function("bambu_network_put_model_mall_rating"));
    get_oss_config_ptr         = reinterpret_cast<func_get_oss_config>(get_network_function("bambu_network_get_oss_config"));
    put_rating_picture_oss_ptr = reinterpret_cast<func_put_rating_picture_oss>(
        get_network_function("bambu_network_put_rating_picture_oss"));
    get_model_mall_rating_result_ptr = reinterpret_cast<func_get_model_mall_rating_result>(
        get_network_function("bambu_network_get_model_mall_rating"));

    get_mw_user_preference_ptr = reinterpret_cast<func_get_mw_user_preference>(
        get_network_function("bambu_network_get_mw_user_preference"));
    get_mw_user_4ulist_ptr = reinterpret_cast<func_get_mw_user_4ulist>(get_network_function("bambu_network_get_mw_user_4ulist"));

    s_network_module_loaded.store(true);
    return 0;
}
...
int NetworkAgent::unload_network_module()
{
    ...
    s_network_module_loaded.store(false);
#if defined(_MSC_VER) || defined(_WIN32)
    if (netwoking_module) {
...
bool NetworkAgent::is_valid() const { return m_alive.load() && s_network_module_loaded.load() && network_agent != nullptr; }
...
#endif
{
    ...
    if (!source_module) {
        ...
        if (library_path.empty()) {
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                    << boost::format(", can not get path in current directory for %1%") % BAMBU_SOURCE_LIBRARY;
            return source_module;
        }
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << boost::format(", current path %1%") % library_path;
        memset(lib_wstr, 0, sizeof(lib_wstr));
    ...
    if (network_agent && set_config_dir_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, config_dir=%3%") % network_agent % ret %
                                            config_dir;
    }
    return ret;
}
...
int NetworkAgent::set_cert_file(std::string folder, std::string filename)
{
    ...
    if (network_agent && set_cert_file_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, folder=%3%, filename=%4%") % network_agent %
                                            ret % folder % filename;
    }
    return ret;
}
...
int NetworkAgent::set_country_code(std::string country_code)
{
    ...
    if (network_agent && set_country_code_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, country_code=%3%") % network_agent % ret %
                                            country_code;
    }
    return ret;
}
...
{
    int ret = 0;
    if (!is_valid() || refresh_connection_ptr == nullptr)
        return ret;
    ...
    try {
        ...
        BOOST_LOG_TRIVIAL(error) << __FUNCTION__ << boost::format(" exception: network_agent=%1%, what=%2%") % network_agent % ex.what();
        ret = -1;
    } catch (...) {
        BOOST_LOG_TRIVIAL(error) << __FUNCTION__ << boost::format(" unknown exception: network_agent=%1%") % network_agent;
        ret = -1;
    }
    return ret;
}
...
int NetworkAgent::start_subscribe(std::string module)
{
    ...
    if (network_agent && start_subscribe_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, module=%3%") % network_agent % ret % module;
    }
    return ret;
}
...
int NetworkAgent::send_message(std::string dev_id, std::string json_str, int qos, int flag)
{
    ...
    if (network_agent && send_message_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, dev_id=%3%, json_str=%4%, qos=%5%") %
...
int NetworkAgent::connect_printer(std::string dev_id, std::string dev_ip, std::string username, std::string password, bool use_ssl)
{
    ...
    if (network_agent && connect_printer_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << (boost::format(
                                             " error: network_agent=%1%, ret=%2%, dev_id=%3%, dev_ip=%4%, username=%5%, password=%6%") %
...
bool NetworkAgent::start_discovery(bool start, bool sending)
{
    ...
    if (network_agent && start_discovery_ptr) {
        ...
        // BOOST_LOG_TRIVIAL(error) << __FUNCTION__ << boost::format(" error: network_agent=%1%, ret=%2%, start=%3%,
        // sending=%4%")%network_agent %ret %start %sending;
    }
    return ret;
}
...
int NetworkAgent::change_user(std::string user_info)
{
    ...
    if (network_agent && change_user_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, user_info=%3%") % network_agent % ret %
                                            user_info;
    }
    return ret;
}
...
int NetworkAgent::ping_bind(std::string ping_code)
{
    ...
    if (network_agent && ping_bind_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, pin code=%3%") % network_agent % ret % ping_code;
    }
    return ret;
}
...
int NetworkAgent::bind_detect(std::string dev_ip, std::string sec_link, detectResult& detect)
{
    ...
    if (network_agent && bind_detect_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, dev_ip=%3%") % network_agent % ret % dev_ip;
    }
    return ret;
}
    ...
    std::string dev_ip, std::string dev_id, std::string sec_link, std::string timezone, bool improved, OnUpdateStatusFn update_fn)
{
    ...
    if (network_agent && bind_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, dev_ip=%3%, timezone=%4%") % network_agent %
                                            ret % dev_ip % timezone;
    }
    return ret;
}
...
int NetworkAgent::unbind(std::string dev_id)
{
    ...
    if (network_agent && unbind_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, user_info=%3%") % network_agent % ret % dev_id;
    }
    return ret;
}
...
int NetworkAgent::start_print(PrintParams params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn)
{
    ...
    if (network_agent && start_print_ptr) {
        if (use_legacy_network) {
            ret = (reinterpret_cast<func_start_print_legacy>(start_print_ptr))(network_agent, as_legacy(params), update_fn, cancel_fn,
                                                                               wait_fn);
        } else {
            ret = start_print_ptr(network_agent, params, update_fn, cancel_fn, wait_fn);
        }
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format(" : network_agent=%1%, ret=%2%, dev_id=%3%, task_name=%4%, project_name=%5%") %
...
int NetworkAgent::start_local_print_with_record(PrintParams params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn)
{
    ...
    if (network_agent && start_local_print_with_record_ptr) {
        if (use_legacy_network) {
            ret = (reinterpret_cast<func_start_local_print_with_record_legacy>(
                start_local_print_with_record_ptr))(network_agent, as_legacy(params), update_fn, cancel_fn, wait_fn);
        } else {
...
int NetworkAgent::start_send_gcode_to_sdcard(PrintParams params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn, OnWaitFn wait_fn)
{
    ...
    if (network_agent && start_send_gcode_to_sdcard_ptr) {
        if (use_legacy_network) {
            ret = (reinterpret_cast<func_start_send_gcode_to_sdcard_legacy>(
                start_send_gcode_to_sdcard_ptr))(network_agent, as_legacy(params), update_fn, cancel_fn, wait_fn);
        } else {
...
int NetworkAgent::start_local_print(PrintParams params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn)
{
    ...
    if (network_agent && start_local_print_ptr) {
        if (use_legacy_network) {
            ret = (reinterpret_cast<func_start_local_print_legacy>(start_local_print_ptr))(network_agent, as_legacy(params), update_fn,
                                                                                           cancel_fn);
        } else {
...
int NetworkAgent::start_sdcard_print(PrintParams params, OnUpdateStatusFn update_fn, WasCancelledFn cancel_fn)
{
    ...
    if (network_agent && start_sdcard_print_ptr) {
        if (use_legacy_network) {
            ret = (reinterpret_cast<func_start_sdcard_print_legacy>(start_sdcard_print_ptr))(network_agent, as_legacy(params), update_fn,
                                                                                             cancel_fn);
        } else {
...
int NetworkAgent::get_user_presets(std::map<std::string, std::map<std::string, std::string>>* user_presets)
{
    ...
    if (network_agent && get_user_presets_ptr) {
        ...
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format(" : network_agent=%1%, ret=%2%, setting_id count=%3%") % network_agent % ret %
                                       user_presets->size();
    }
    return ret;
}
...
std::string NetworkAgent::request_setting_id(std::string name, std::map<std::string, std::string>* values_map, unsigned int* http_code)
{
    ...
    if (network_agent && request_setting_id_ptr) {
        ...
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format(" : network_agent=%1%, name=%2%, http_code=%3%, ret.setting_id=%4%") % network_agent %
                                       name % (*http_code) % ret;
    }
    return ret;
}
                              ...
                              unsigned int*                       http_code)
{
    ...
    if (network_agent && put_setting_ptr) {
        ...
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format(" : network_agent=%1%, setting_id=%2%, name=%3%, http_code=%4%, ret=%5%") % network_agent %
                                       setting_id % name % (*http_code) % ret;
    }
    return ret;
}
...
int NetworkAgent::get_setting_list(std::string bundle_version, ProgressFn pro_fn, WasCancelledFn cancel_fn)
{
    ...
    if (network_agent && get_setting_list_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                    << boost::format(" error: network_agent=%1%, ret=%2%, bundle_version=%3%") % network_agent % ret %
                                           bundle_version;
    }
    return ret;
}
...
int NetworkAgent::delete_setting(std::string setting_id)
{
    ...
    if (network_agent && delete_setting_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, setting_id=%3%") % network_agent % ret %
                                            setting_id;
    }
    return ret;
}
...
int NetworkAgent::set_extra_http_header(std::map<std::string, std::string> extra_headers)
{
    ...
    if (network_agent && set_extra_http_header_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, extra_headers count=%3%") % network_agent % ret %
                                            extra_headers.size();
    }
    return ret;
}
...
int NetworkAgent::check_user_task_report(int* task_id, bool* printable)
{
    ...
    if (network_agent && check_user_task_report_ptr) {
        ...
        BOOST_LOG_TRIVIAL(debug) << __FUNCTION__
                                 << boost::format(" error: network_agent=%1%, ret=%2%, task_id=%3%, printable=%4%") % network_agent % ret %
                                        (*task_id) % (*printable);
    }
    return ret;
}
...
int NetworkAgent::get_user_print_info(unsigned int* http_code, std::string* http_body)
{
    ...
    if (network_agent && get_user_print_info_ptr) {
        ...
        BOOST_LOG_TRIVIAL(debug) << __FUNCTION__
                                 << boost::format(" error: network_agent=%1%, ret=%2%, http_code=%3%, http_body=%4%") % network_agent %
                                        ret % (*http_code) % (*http_body);
    }
    return ret;
}
...
int NetworkAgent::get_user_tasks(TaskQueryParams params, std::string* http_body)
{
    ...
    if (network_agent && get_user_tasks_ptr) {
        ...
        BOOST_LOG_TRIVIAL(debug) << __FUNCTION__
                                 << boost::format(" error: network_agent=%1%, ret=%2%, http_body=%3%") % network_agent % ret % (*http_body);
    }
    return ret;
}
...
int NetworkAgent::get_printer_firmware(std::string dev_id, unsigned* http_code, std::string* http_body)
{
    ...
    if (network_agent && get_printer_firmware_ptr) {
        ...
        BOOST_LOG_TRIVIAL(debug) << __FUNCTION__
                                 << boost::format(" : network_agent=%1%, ret=%2%, dev_id=%3%, http_code=%4%, http_body=%5%") %
...
int NetworkAgent::get_task_plate_index(std::string task_id, int* plate_index)
{
    ...
    if (network_agent && get_task_plate_index_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, task_id=%3%") % network_agent % ret % task_id;
    }
    return ret;
}
...
int NetworkAgent::get_slice_info(std::string project_id, std::string profile_id, int plate_index, std::string* slice_json)
{
    ...
    if (network_agent && get_slice_info_ptr) {
        ...
        BOOST_LOG_TRIVIAL(debug) << __FUNCTION__
                                 << boost::format(" : network_agent=%1%, project_id=%2%, profile_id=%3%, plate_index=%4%, slice_json=%5%") %
...
int NetworkAgent::modify_printer_name(std::string dev_id, std::string dev_name)
{
    ...
    if (network_agent && modify_printer_name_ptr) {
        ...
        BOOST_LOG_TRIVIAL(info) << __FUNCTION__
                                << boost::format(" : network_agent=%1%, ret=%2%, dev_id=%3%, dev_name=%4%") % network_agent % ret % dev_id %
                                       dev_name;
    }
    return ret;
}
...
int NetworkAgent::get_camera_url(std::string dev_id, std::function<void(std::string)> callback)
{
    ...
    if (network_agent && get_camera_url_ptr) {
        ...
        if (ret)
            BOOST_LOG_TRIVIAL(error) << __FUNCTION__
                                     << boost::format(" error: network_agent=%1%, ret=%2%, dev_id=%3%") % network_agent % ret % dev_id;
    }
    return ret;
}
...
int NetworkAgent::put_model_mall_rating(
    int rating_id, int score, std::string content, std::vector<std::string> images, unsigned int& http_code, std::string& http_error)
{
    int ret = 0;
    if (network_agent && get_model_publish_url_ptr) {
...
int NetworkAgent::put_rating_picture_oss(
